...
class MethodLibraryTest {
    private val ev: EvaluationTestCase = EvaluationTestCase()

    // Asserts that evaluation of src fails with the specified stack.
    private fun checkEvalErrorStack(src: String, stack: String?) {
        val ex: EvalException = org.junit.Assert.assertThrows<T>(
            EvalException::class.java,
            org.junit.function.ThrowingRunnable { ev.exec(src) })
        val reader: SourceReader =
            SourceReader { loc ->
                // ignore filename
                val lines: MutableList<String?> = com.google.common.base.Splitter.on('\n').splitToList(src)
                if (loc.line() > 0 && loc.line() <= lines.size) lines.get(loc.line() - 1) else null
            }
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testStackTraceWithAugmentedAssignment() {
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testStackErrorInBuiltinFunction() {
        // at top level
        checkEvalErrorStack(
            "len(1)",
            join(
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testBuiltinFunctionErrorMessage() {
        ev.Scenario()
    ...
    fun testHasAttr() {
        ev.Scenario()
            .testExpression("hasattr([], 'append')", java.lang.Boolean.TRUE)
            .testExpression("hasattr('test', 'count')", java.lang.Boolean.TRUE)
            .testExpression("hasattr(dict(a = 1, b = 2), 'items')", java.lang.Boolean.TRUE)
            .testExpression("hasattr({}, 'items')", java.lang.Boolean.TRUE)
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testGetAttrMissingField() {
        ev.Scenario()
            .testIfExactError(
    ...
    internal class AStruct : Structure, StarlarkValue {
        ...
        val fieldNames: com.google.common.collect.ImmutableCollection<String?>
            get() = com.google.common.collect.ImmutableList.of<String?>("field")
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testGetAttrMissingField_typoDetection() {
        ev.Scenario()
            .update("s", AStruct())
            .testIfExactError(
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testGetAttrWithMethods() {
        val msg = "'string' value has no field or method 'cnt'"
        ev.Scenario()
    ...
    fun testAbs() {
        ev.Scenario() // int
            .testEval("abs(4)", "4")
            .testEval("abs(-2)", "2")
            .testEval("abs(0)", "0") // float
            .testEval("abs(-2.3)", "2.3")
            .testEval("abs(5.2)", "5.2")
            .testEval("abs(0.0)", "0.0") // big int
    ...
    @Throws(java.lang.Exception::class)
    fun testBoolean() {
        ev.Scenario().testExpression("False", java.lang.Boolean.FALSE).testExpression("True", java.lang.Boolean.TRUE)
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testBooleanUnsupportedOperationFails() {
        ev.Scenario()
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryCopyKeyCollision() {
        ev.Scenario().setUp("x = {'test' : 2}", "y = dict(x, test = 3)").testEval("y['test']", "3")
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryKeyNotFound() {
        ev.Scenario()
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryVariableAccess() {
        ev.Scenario().setUp("d = {'a' : 1}", "a = d['a']").testLookup("a", StarlarkInt.of(1))
    }
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryCreationInnerLists() {
        ev.Scenario().testEval("dict([[1, 2], [3, 4]], a = 5)", "{1: 2, 3: 4, 'a': 5}")
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryCreationEmpty() {
        ev.Scenario().testEval("dict()", "{}").testEval("dict([])", "{}")
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryCreationDifferentKeyTypes() {
        val expected = "{'a': 1, 2: 3}"
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryCreationKeyCollision() {
        val expected = "{'a': 1, 'b': 2, 'c': 3}"

        ev.Scenario()
            .testEval("dict([('a', 42), ('b', 2), ('a', 1), ('c', 3)])", expected)
            .testEval("dict([('a', 42)], a = 1, b = 2, c = 3)", expected)
        ev.Scenario().testEval("dict([('a', 42)], **{'a': 1, 'b': 2, 'c': 3})", expected)
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testDictionaryCreationInvalidPositional() {
        ev.Scenario()
            .testIfErrorContains("in dict, got string, want iterable", "dict('a')")
            .testIfErrorContains(
    ...
    fun testRangeType() {
        ev.Scenario()
            ...
            .testExpression("range(1, 10, 2) == range(1, 12, 2)", false) // x in range(...), +ve step
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testEnumerateBadArg() {
        ev.Scenario().testIfErrorContains("type 'string' is not iterable", "enumerate('a')")
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testReassignmentOfPrimitivesNotForbiddenByCoreLanguage() {
        ev.Scenario()
    ...
    @Throws(java.lang.Exception::class)
    fun testLenOnString() {
        ev.Scenario().testExpression("len('abc')", StarlarkInt.of(3))
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testLenOnList() {
        ev.Scenario().testExpression("len([1,2,3])", StarlarkInt.of(3))
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testLenOnDict() {
        ev.Scenario().testExpression("len({'a' : 1, 'b' : 2})", StarlarkInt.of(2))
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testLenOnBadType() {
        ev.Scenario().testIfErrorContains("want 'iterable or string'", "len(1)")
    }

    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testIndexOnFunction() {
        ev.Scenario()
    ...
    fun testBool() {
        ev.Scenario()
            .testExpression("bool(1)", java.lang.Boolean.TRUE)
            .testExpression("bool(0)", java.lang.Boolean.FALSE)
            .testExpression("bool([1, 2])", java.lang.Boolean.TRUE)
            .testExpression("bool([])", java.lang.Boolean.FALSE)
            .testExpression("bool(None)", java.lang.Boolean.FALSE)
    }
    ...
    @Throws(java.lang.Exception::class)
    fun testStrFunction() {
        ev.Scenario().setUp("def foo(x): pass").testExpression("str(foo)", "<function foo>")
    }
    ...
    private fun checkStrip(
        input: String?, chars: Any?, expLeft: String?, expRight: String?, expBoth: String?
    ) {
        if (chars == null) {
            ev.Scenario()
                .update("s", input)
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testPositionalOnlyArgument() {
        ev.Scenario()
            .testIfErrorContains(
    ...
    internal class NamedOnly : StarlarkValue {
        @StarlarkMethod(
            name = "foo",
            documented = false,
            parameters = [Param(name = "a"), Param(name = "b", named = true, defaultValue = "None", positional = false)]
        )
        fun foo(a: Any?, b: Any?): Any? {
            return a
        }
    }
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testNamedOnlyArgument() {
        ev.Scenario()
            .update("named_only", NamedOnly())
            .testIfErrorContains(
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testStringJoinRequiresStrings() {
        ev.Scenario()
            .testIfErrorContains(
