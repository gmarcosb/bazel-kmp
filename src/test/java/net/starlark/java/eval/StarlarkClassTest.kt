...
/** Tests for static utility methods in the [Starlark] class.  */
@RunWith(JUnit4::class)
class StarlarkClassTest {
    @org.junit.Test
    fun trimDocString() {
    ...
    fun expandTabs() {
        ...
        org.junit.Assert.assertThrows<java.lang.IllegalArgumentException?>(
            ...
            org.junit.function.ThrowingRunnable { Starlark.expandTabs("\t", 0) })
        org.junit.Assert.assertThrows<java.lang.IllegalArgumentException?>(
            java.lang.IllegalArgumentException::class.java,
            org.junit.function.ThrowingRunnable { Starlark.expandTabs("\t", -1) })
    }
}
