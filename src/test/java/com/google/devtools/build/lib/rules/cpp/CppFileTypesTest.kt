...
/**
 * Test for [CppFileTypes].
 */
@RunWith(JUnit4::class)
class CppFileTypesTest {
    @org.junit.Test
    fun testTwoDotExtensions() {
    ...
    @org.junit.Test
    fun testVersionedSharedLibraries() {
    ...
    @org.junit.Test
    fun testCaseSensitiveAssemblyFiles() {
