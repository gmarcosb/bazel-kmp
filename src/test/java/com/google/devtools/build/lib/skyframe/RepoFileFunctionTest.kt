...
class RepoFileFunctionTest : BuildViewTestCase() {
    @org.junit.Test
    ...
    fun featureMerger() {
        ...
        invalidatePackages()
        val ruleContext: RuleContext = getRuleContext(getConfiguredTarget("//abc/def:what"))
