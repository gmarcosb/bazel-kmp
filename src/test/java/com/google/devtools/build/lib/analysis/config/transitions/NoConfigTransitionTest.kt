...
class NoConfigTransitionTest : BuildViewTestCase() {
    ...
    fun preventsConfiguredTargetForking() {
        ...
        val parent1: ConfiguredTarget? = getConfiguredTarget("//foo:parent1")
        val parent2: ConfiguredTarget? = getConfiguredTarget("//foo:parent2")
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun preventsConfiguredTargetForkingOnCoreOptions() {
    ...
    companion object {
        ...
        private val NO_CONFIG_RULE: MockRule = MockRule {
            MockRule.define(
                "no_config_rule",
                MockRuleCustomBehavior { builder: RuleClass.Builder?, env: RuleDefinitionEnvironment? ->
                    builder.cfg(NoConfigTransition.getFactory())
                })
        }
    }
}
