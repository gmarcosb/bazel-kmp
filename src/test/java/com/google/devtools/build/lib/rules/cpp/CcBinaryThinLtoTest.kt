...
class CcBinaryThinLtoTest : BuildViewTestCase() {
    ...
    */
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testLtoBackendEnv() {
        createBuildFiles("features = ['env_feature'],")
        setupThinLTOCrosstool(MockCcSupport.ENV_VAR_FEATURES)

        val backendAction: LtoBackendAction =
            getBackendAction("pkg/bin.lto/" + this.rootExecPath + "/pkg/_objs/bin/binfile.o")
        assertThat(backendAction.getMnemonic()).isEqualTo("CcLtoBackendCompile")
    ...
    fun testFission() {
        ...
        validateDwp(
            ...
            com.google.common.collect.ImmutableList.of<String?>(
                rootPrefix.toString() + "/pkg/bin.lto/" + rootExecPath + "/pkg/_objs/lib/libfile.pic.dwo",
                rootPrefix.toString() + "/pkg/bin.lto/" + rootExecPath + "/pkg/_objs/bin/binfile.pic.dwo"
            )
        )
    }
    ...
    fun testAssemblerSource() {
        ...
        val bin: ConfiguredTarget = getConfiguredTarget("//pkg:bin")

        val binArtifact: Artifact = getFilesToBuild(bin).getSingleton()
        ...
        val dataGen: Action? = getPredecessorByInputName(linkAction, "tracing_x86-64")
    ...
    */
    ...
    fun testAutoFdo() {
        ...
        com.google.common.truth.Subject.contains("profile.afdo")
    }
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testPropellerCcCompileWithThinLtoDisabled() {
        scratch.file(
            "pkg/BUILD",
            "package(features = ['thin_lto'])",
            "",
        ...
        val compileAction: CppCompileAction? =
            getPredecessorByInputName(linkAction, "pkg/_objs/lib/libfile.o") as CppCompileAction?
        com.google.common.truth.Subject.contains("cc_profile.txt")
        Truth.assertThat(com.google.common.base.Joiner.on(" ").join(compileAction.getArguments()))
            .containsMatch("-fbasic-block-sections=list=.*/cc_profile.txt")
    }
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun testThinLtoWithoutSupportsStartEndLibError() {
        createBuildFiles("testonly = 1,")
        AnalysisMock.get()
            .ccSupport()
            .setupCcToolchainConfig(
