 ...
 * 
 * 
 * This suite is for test cases that want a normal rule class provider, unlike
 * BuiltinsInjectionTest, which has a minimal environment.
 */
@RunWith(JUnit4::class)
class BuiltinsIntegrationTest : BuildViewTestCase() {
    ...
    fun builtinsDummyIsNotAPublicApi() {
    ...
    @org.junit.Test
    @Throws(java.lang.Exception::class)
    fun builtinsInjectionWorksInBuildViewTestCase() {
        scratch.file("pkg/BUILD", "load(':foo.bzl', 'foo')")
