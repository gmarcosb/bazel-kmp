 ...
 */
interface ConfiguredAspectFactory {
    /**
     ...
     */
    @Throws(ActionConflictException::class, java.lang.InterruptedException::class, RuleErrorException::class)
    fun create(
        targetLabel: Label?,
        ct: ConfiguredTarget?,
        context: RuleContext?,
    ...
    fun addAspectImplSpecificRequiredConfigFragments(
