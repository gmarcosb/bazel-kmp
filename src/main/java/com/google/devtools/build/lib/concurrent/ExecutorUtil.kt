...
object ExecutorUtil {
     ...
     */
    fun uninterruptibleShutdownNow(executor: ExecutorService): Boolean {
        return com.google.devtools.build.lib.concurrent.ExecutorUtil.shutdownImpl(
            executor,  /*shutdownNowInitially=*/
            true,  /*shutdownNowOnInterrupt=*/
            false
        )
    }
     ...
     * @return true iff interrupted.
     */
    fun interruptibleShutdown(executor: ExecutorService): Boolean {
        return com.google.devtools.build.lib.concurrent.ExecutorUtil.shutdownImpl(
            executor,  /*shutdownNowInitially=*/
     ...
     * @return true iff interrupted.
     */
    fun uninterruptibleShutdown(executor: ExecutorService): Boolean {
        return com.google.devtools.build.lib.concurrent.ExecutorUtil.shutdownImpl(
            executor,  /*shutdownNowInitially=*/
            false,  /*shutdownNowOnInterrupt=*/
            false
    ...
    private fun shutdownImpl(
        executor: ExecutorService, shutdownNowInitially: Boolean, shutdownNowOnInterrupt: Boolean
    ): Boolean {
        com.google.common.base.Preconditions.checkState(!executor.isShutdown())
     ...
     */
    fun newSlackPool(threads: Int, name: String?): ThreadPoolExecutor {
        ...
        val pool: ThreadPoolExecutor = ThreadPoolExecutor(
            ...
            3L,
            TimeUnit.SECONDS,
            SynchronousQueue<java.lang.Runnable?>(),
            com.google.common.util.concurrent.ThreadFactoryBuilder().setNameFormat(name + " %d").build(),
            java.util.concurrent.RejectedExecutionHandler { r: java.lang.Runnable?, e: ThreadPoolExecutor? -> r.run() })
