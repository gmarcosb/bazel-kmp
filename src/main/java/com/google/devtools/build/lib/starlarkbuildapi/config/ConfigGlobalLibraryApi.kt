...
interface ConfigGlobalLibraryApi {
    @net.starlark.java.annot.StarlarkMethod(
        name = "transition",
        doc = ("A transition that reads a set of input build settings and writes a set of output build "
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            positional = false,
            named = true,
            doc = ("The function implementing this transition. This function always has two "
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        doc = ("<p> Creates a configuration transition to be applied on an analysis-test rule's"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            positional = false,
            named = true,
            doc = ("A dictionary containing information about configuration settings which "
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        doc = ("A specialized version of <a"
