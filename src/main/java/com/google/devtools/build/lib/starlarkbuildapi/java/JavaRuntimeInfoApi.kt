...
interface JavaRuntimeInfoApi : StructApi {
    @StarlarkMethod(
        name = "java_home",
    ...
    fun javaBinaryExecPath(): String?

    /** The runfiles path of the JDK.  */
    @StarlarkMethod(
        name = "java_home_runfiles_path",
        doc = ("Returns the path of the Java installation in runfiles trees. This should only be used "
    ...
    fun javaHomeRunfilesPath(): String?
    ...
    fun javaBinaryRunfilesPath(): String?

    /** The files in the Java runtime.  */
    @StarlarkMethod(name = "files", doc = "Returns the files in the Java runtime.", structField = true)
    fun starlarkJavaBaseInputs(): Depset?
    ...
    fun starlarkHermeticInputs(): Depset?
    ...
    fun defaultCDS(): FileApi?

    /** The JDK static libraries needed for hermetic deployments.  */
    @StarlarkMethod(name = "hermetic_static_libs", doc = "Returns the JDK static libraries.", structField = true)
    fun starlarkHermeticStaticLibs(): Sequence<*>?
