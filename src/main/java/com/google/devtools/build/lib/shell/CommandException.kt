 ...
 */
open class CommandException : java.lang.Exception {
    private val command: com.google.devtools.build.lib.shell.Command?

    /** Returns the command that failed.  */
    fun getCommand(): com.google.devtools.build.lib.shell.Command? {
        return command
    }

    constructor(command: com.google.devtools.build.lib.shell.Command?, message: String?) : super(message) {
        this.command = command
    }

    constructor(command: com.google.devtools.build.lib.shell.Command?, cause: Throwable?) : super(cause) {
        this.command = command
    }

    constructor(
        command: com.google.devtools.build.lib.shell.Command?, message: String?,
        cause: Throwable?
    ) : super(message, cause) {
        this.command = command
    }
