...
interface GrpcCommandServer {
    ...
    interface Responder {
         ...
         * 
         * 
         * May be called multiple times for a streaming RPC.
         * 
         * @param response the response to send in wire format
         * @throws IOException if an I/O error occurs
         */
        @Throws(IOException::class)
        fun onNext(response: ByteArray?)

        /**
         * Signals that the response is complete.
         * 
         * 
         * Must be called exactly once, after which [.onNext] must not be called again.
         * 
         * @throws IOException if an I/O error occurs
         */
        @Throws(IOException::class)
    ...
    interface Callback {
         ...
         * Handles a Run RPC.
         * 
         * @param request a serialized [com.google.devtools.build.lib.server.RunRequest]
         * @param responder a responder accepting serialized [     ]
         */
        fun run(request: ByteArray?, responder: Responder?)

        /**
         * Handles a Cancel RPC.
         * 
         * @param request a serialized [com.google.devtools.build.lib.server.CancelRequest]
         * @param responder a responder accepting serialized [     ]
         */
        fun cancel(request: ByteArray?, responder: Responder?)

        /**
         * Handles a Ping RPC.
         * 
         * @param request a serialized [com.google.devtools.build.lib.server.PingRequest]
         * @param responder a responder accepting serialized [     ]
         */
        fun ping(request: ByteArray?, responder: Responder?)
    }
     ...
     */
    @Throws(IOException::class)
    fun serve(port: Int, callback: Callback?): java.net.SocketAddress?
