 ...
 */
class GenRuleBaseRule : RuleDefinition {
    public override fun build(
        builder: RuleClass.Builder, env: RuleDefinitionEnvironment?
    ): RuleClass {
        return builder
            .autoExecGroupsMode(AutoExecGroupsMode.DISABLED) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(srcs) -->
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("outs", OUTPUT_LIST).mandatory()) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(cmd) -->
        The command to run.
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("cmd", STRING)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(cmd_bash) -->
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("cmd_bash", STRING)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(cmd_bat) -->
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("cmd_bat", STRING)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(cmd_ps) -->
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("cmd_ps", STRING)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(output_to_bindir) -->
        <p>
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("local", BOOLEAN).value(false)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(message) -->
        A progress message.
        <p>
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("message", STRING)) /*<!-- #BLAZE_RULE(genrule).ATTRIBUTE(output_licenses) -->
        See <a href="${link common-definitions#binary.output_licenses}"><code>common attributes
        </code></a>
        <!-- #END_BLAZE_RULE.ATTRIBUTE -->*/
            .add(attr("output_licenses", STRING_LIST)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(executable) -->
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .add(attr("heuristic_label_expansion", BOOLEAN).value(false)) /* <!-- #BLAZE_RULE(genrule).ATTRIBUTE(toolchains) -->
        <p>
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE --> */
            ...
            .override(
                attr("toolchains", LABEL_LIST)
                    .allowedFileTypes(FileTypeSet.NO_FILE) // Accept TemplateVariableInfo and/or ToolchainTypeInfo.
                    .mandatoryProvidersList(
                        ImmutableList.of<E?>(
                            ImmutableList.of<E?>(TemplateVariableInfo.PROVIDER.id()),
                            ImmutableList.of<E?>(ToolchainTypeInfo.PROVIDER.id())
                        )
                    )
    ...
    val metadata: RuleDefinition.Metadata
        get() = RuleDefinition.Metadata.builder()
            ...
            .ancestors(
                BaseRuleClasses.NativeActionCreatingRule::class.java,
