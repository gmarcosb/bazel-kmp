...
@net.starlark.java.annot.StarlarkBuiltin(
    ...
    doc = ("A built-in module to support native rules and other package helper functions. "
...
interface StarlarkNativeModuleApi : net.starlark.java.eval.StarlarkValue {
    @net.starlark.java.annot.StarlarkMethod(
        name = "glob",
        doc = ("Glob returns a new, mutable, sorted list of every file in the current package "
                + "that:<ul>\n"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            named = true,
            doc = ("Whether we allow glob patterns to match nothing. If `allow_empty` is False, each"
    ...
    fun glob(
        ...
        excludeDirectories: net.starlark.java.eval.StarlarkInt?,
        allowEmpty: Any?,
    ...
    @net.starlark.java.annot.StarlarkMethod(
        name = "existing_rule",
        doc = ("Returns an immutable dict-like object that describes the attributes of a rule"
        ...
        parameters = [net.starlark.java.annot.Param(name = "name", doc = "The name of the target.")],
        useStarlarkThread = true
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun existingRule(name: String?, thread: net.starlark.java.eval.StarlarkThread?): Any?

    @net.starlark.java.annot.StarlarkMethod(
        name = "existing_rules",
        doc = ("Returns an immutable dict-like object describing the rules so far instantiated in this"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun existingRules(thread: net.starlark.java.eval.StarlarkThread?): Any?
    ...
    fun packageGroup(
        name: String?,
        packages: net.starlark.java.eval.Sequence<*>?,
        includes: net.starlark.java.eval.Sequence<*>?,
        thread: net.starlark.java.eval.StarlarkThread?
    ...
    @net.starlark.java.annot.StarlarkMethod(
        name = "package_name", doc = ("The name of the package being evaluated, without the repository name. "
                ...
                + "The value will always be an empty string for the root package."), useStarlarkThread = true
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun packageName(thread: net.starlark.java.eval.StarlarkThread?): String?

    @net.starlark.java.annot.StarlarkMethod(
        name = "package_default_visibility",
        doc = ("Returns the default visibility of the package being evaluated. This is the value of the"
                + " <code>default_visibility</code> parameter of <code>package()</code>, extended to"
                + " include the package itself."),
        useStarlarkThread = true
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun packageDefaultVisibility(thread: net.starlark.java.eval.StarlarkThread?): MutableList<Label?>?

    @net.starlark.java.annot.StarlarkMethod(
        name = "repository_name",
        doc = ("<strong>Deprecated.</strong> Prefer to use <a"
    ...
    @Deprecated("")
    @Throws(net.starlark.java.eval.EvalException::class)
    fun repositoryName(thread: net.starlark.java.eval.StarlarkThread?): String?

    @net.starlark.java.annot.StarlarkMethod(
        name = "repo_name",
        doc = ("The canonical name of the repository containing the package currently being evaluated,"
                + " with no leading at-signs."),
        useStarlarkThread = true
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun repoName(thread: net.starlark.java.eval.StarlarkThread?): String?

    @net.starlark.java.annot.StarlarkMethod(
        name = "package_relative_label",
        doc = ("Converts the input string into a <a href='../builtins/Label.html'>Label</a> object, in"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun packageRelativeLabel(input: Any?, thread: net.starlark.java.eval.StarlarkThread?): Label?

    @net.starlark.java.annot.StarlarkMethod(
        name = "module_name", doc = ("The name of the Bazel module associated with the repo this package is in. If this"
                ...
                + " in <code>module_ctx.modules</code>."), allowReturnNones = true, useStarlarkThread = true
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun moduleName(thread: net.starlark.java.eval.StarlarkThread?): String?

    @net.starlark.java.annot.StarlarkMethod(
        name = "module_version",
        doc = ("The version of the Bazel module associated with the repo this package is in. If this"
                + " package is from a repo defined in WORKSPACE instead of MODULE.bazel, this is"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun moduleVersion(thread: net.starlark.java.eval.StarlarkThread?): String?

    @net.starlark.java.annot.StarlarkMethod(
        name = "subpackages",
        doc = ("Returns a new mutable list of every direct subpackage of the current package,"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            positional = false,
            named = true,
            doc = ("Whether we fail if the call returns an empty list. By default empty list indicates"
