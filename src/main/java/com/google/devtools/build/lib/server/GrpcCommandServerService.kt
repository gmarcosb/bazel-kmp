...
/** A [BlazeService] providing a [GrpcCommandServer].  */
@com.google.devtools.build.lib.skybridge.SkybridgeInterface
interface GrpcCommandServerService : BlazeService {
    /**
     * Returns the [GrpcCommandServer].
     * 
     * 
     * The return value is a singleton; multiple calls will return the same object.
     */
