...
/** The [GrpcCommandServerService] implementation.  */
class GrpcCommandServerServiceImpl : GrpcCommandServerService {
    val grpcCommandServer: GrpcCommandServer = GrpcCommandServerImpl()
}
