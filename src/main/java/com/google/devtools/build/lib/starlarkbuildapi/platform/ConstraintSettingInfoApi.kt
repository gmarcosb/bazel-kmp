...
@StarlarkBuiltin(
    name = "ConstraintSettingInfo", doc = ("A specific constraint setting that may be used to define a platform. See "
...
interface ConstraintSettingInfoApi : StructApi {
    @StarlarkMethod(
        name = "label",
    ...
    fun defaultConstraintValue(): ConstraintValueInfoApi?
    ...
    fun hasDefaultConstraintValue(): Boolean
}
