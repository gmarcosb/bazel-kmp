 ...
 * 
 * 
 * Artifact is the only notable implementer of the interface, but the interface remains
 ...
 * 
 * 
 * ActionInput is used as a cache "key" for ActionInputFileCache: for Artifacts, the
