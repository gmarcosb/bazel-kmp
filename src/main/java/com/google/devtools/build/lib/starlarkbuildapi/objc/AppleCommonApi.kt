...
interface AppleCommonApi<ConstraintValueT : ConstraintValueInfoApi?, StarlarkRuleContextT : StarlarkRuleContextApi<ConstraintValueT?>?>
    : StarlarkValue {
    @get:StarlarkMethod(
        name = "apple_toolchain",
        doc = "Utilities for resolving items from the apple toolchain."
    )
    val appleToolchain: Any?
        get() {
    ...
    val platformTypeStruct: StructApi?
        get() {
            throw UnsupportedOperationException() // just for docs
        }

    @get:StarlarkMethod(
        name = "platform", doc = ("An enum-like struct that contains the following fields corresponding to Apple "
                + "platforms:<br><ul>" //
                ...
                + "XcodeVersionConfig.sdk_version_for_platform</a>."), structField = true
    )
    val platformStruct: StructApi?

    @get:StarlarkMethod(
        name = "XcodeProperties", doc = ("The constructor/key for the <code>XcodeVersionProperties</code> provider.<p>"
    ...
    val xcodeVersionPropertiesConstructor: ProviderApi?
        get() {
            throw UnsupportedOperationException() // just for docs
        }
    ...
    val xcodeVersionConfigConstructor: ProviderApi?
        get() {
            throw UnsupportedOperationException() // just for docs
        }
    ...
    @StarlarkMethod(
        ...
        doc = ("Returns a <a href='../core/dict.html'>dict</a> of environment variables that should be"
    ...
    fun getAppleHostSystemEnv(xcodeConfig: Any?): ImmutableMap<String?, String?>? {
        throw UnsupportedOperationException() // just for docs
    }
    ...
    fun getTargetAppleEnvironment(
        xcodeConfig: Any?, platform: Any?
    ...
    @StarlarkMethod(
        ...
        parameters = [Param(name = "version", doc = "The string representation of the DottedVersion.")]
    )
    @Throws(
        EvalException::class
    )
    fun dottedVersion(version: String?): DottedVersionApi<*>?
}
