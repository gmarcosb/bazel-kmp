...
enum class FileStateType(name: String) {
    REGULAR_FILE("file"),

    /**
     * A special file such as a socket, fifo, or device. See
     * [com.google.devtools.build.lib.vfs.FileStatus.isSpecialFile].
     */
     ...
     */
    fun isFile(): Boolean {
        return this == FileStateType.REGULAR_FILE
    }
    ...
    fun isSpecialFile(): Boolean {
        return this == FileStateType.SPECIAL_FILE
    }
    ...
    fun isDirectory(): Boolean {
        return this == FileStateType.DIRECTORY
    }
}