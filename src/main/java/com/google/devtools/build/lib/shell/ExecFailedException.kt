 ...
 * [Runtime.exec] fails.
 */
class ExecFailedException(command: com.google.devtools.build.lib.shell.Command?, cause: Throwable?) :
    com.google.devtools.build.lib.shell.CommandException(command, cause) {
    companion object {
