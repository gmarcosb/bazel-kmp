 ...
 * 
 * 
 * This exception should be thrown deterministically, i.e. the command line should fail to expand
 ...
 */
class CommandLineExpansionException
/**
 ...
 * @param cause optional exception cause used for debugging only -- `userVisibleErrorMessage` should carry all of the information needed for the user.
 */
@kotlin.jvm.JvmOverloads constructor(userVisibleErrorMessage: String?, cause: Throwable? = null) :
