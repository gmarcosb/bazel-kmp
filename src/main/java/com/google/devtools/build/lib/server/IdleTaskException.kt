...
/**
 * An exception thrown by an [IdleTask] when it fails for a reason other than interruption by
 * the [IdleTaskManager].
 */
class IdleTaskException(cause: java.lang.Exception?) : java.lang.Exception(cause)
