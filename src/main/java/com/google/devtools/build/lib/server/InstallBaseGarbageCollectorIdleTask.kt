...
/** An [IdleTask] to run a [InstallBaseGarbageCollector].  */
class InstallBaseGarbageCollectorIdleTask private constructor(gc: InstallBaseGarbageCollector) :
    com.google.devtools.build.lib.server.IdleTask {
    private val gc: InstallBaseGarbageCollector
    ...
    val garbageCollector: InstallBaseGarbageCollector
        get() = gc
    ...
    companion object {
        /**
         * Creates a new [InstallBaseGarbageCollectorIdleTask] according to the options.
         * 
        ...
        ): InstallBaseGarbageCollectorIdleTask {
            return InstallBaseGarbageCollectorIdleTask(
                InstallBaseGarbageCollector(installBase.getParentDirectory(), installBase, maxAge)
            )
        }
    }
}
