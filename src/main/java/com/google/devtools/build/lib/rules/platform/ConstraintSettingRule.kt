...
/** Rule definition for [ConstraintSetting].  */
class ConstraintSettingRule : RuleDefinition {
    ...
    val metadata: RuleDefinition.Metadata
        get() = RuleDefinition.Metadata.builder()
            ...
            .factoryClass(ConstraintSetting::class.java)
            .build()

    companion object {
        const val RULE_NAME: String = "constraint_setting"
        const val DEFAULT_CONSTRAINT_VALUE_ATTR: String = "default_constraint_value"
    }
