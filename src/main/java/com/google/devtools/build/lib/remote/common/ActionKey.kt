...
/**
 * A key in the remote action cache. The type wraps around a [Digest] of an [Action].
 ...
 */
class ActionKey(digest: Digest?) {
    val digest: Digest?

    init {
        this.digest = digest
        com.google.common.base.Preconditions.checkNotNull<Any?>(digest, "digest")
    }
}
