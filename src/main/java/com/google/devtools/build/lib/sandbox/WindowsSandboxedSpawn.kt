...
class WindowsSandboxedSpawn(
    ...
    val sandboxDebugPath: com.google.devtools.build.lib.vfs.Path?
        get() =// On Windows, sandbox debugging output is written to stderr rather than a separate file.
            null

    val statisticsPath: com.google.devtools.build.lib.vfs.Path?
        get() =// On Windows, Bazel currently does not support per-process statistics.
            null
