...
/**
 * Options that affect the *mechanism* of analysis. These are distinct from [ ], which affect the *value* of a
 * BuildConfigurationValue.
 */
@OptionsClass
abstract class AnalysisOptions : OptionsBase() {
    @Option(
    ...
    abstract fun getDiscardAnalysisCache(): Boolean
    ...
    abstract fun getAllowAnalysisCacheDiscards(): Boolean
    ...
    @Option(
        ...
        help = ("When discarding the analysis cache due to a change in the build options, "
                + "displays up to the given number of changed option names. "
                + "If the number given is -1, all changed options will be displayed.")
    )
    abstract fun getMaxConfigChangesToShow(): Int
    ...
    abstract fun getSkipIncompatibleExplicitTargets(): Boolean
    ...
    abstract fun getExtraActionFilter(): RegexFilter?
    ...
    abstract fun getExtraActionTopLevelOnly(): Boolean
    ...
    abstract fun getVersionWindowForDirtyNodeGc(): Long
    ...
    @Option(
        ...
        help = ("If set to a positive value (e.g. `"
    ...
    abstract fun getCpuHeavySkyKeysThreadPoolSize(): Int
    ...
    @Option(
        ...
        help = ("Sets the size of the semaphore used to prevent SkyFunctions with large peak memory"
    ...
    abstract fun getOomSensitiveSkyFunctionsSemaphoreSize(): Int
}
