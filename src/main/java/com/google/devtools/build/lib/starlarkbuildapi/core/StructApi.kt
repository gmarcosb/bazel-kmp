...
@StarlarkBuiltin(
    name = "struct", category = DocCategory.BUILTIN, doc = ("A generic object with fields."
...
interface StructApi : StarlarkValue {
    /** Callable Provider for new struct objects.  */
    @StarlarkBuiltin(name = "Provider", documented = false, doc = "")
    interface StructProviderApi : ProviderApi {
        @StarlarkMethod(
            name = "struct",
            doc = ("Creates an immutable struct using the keyword arguments as attributes. It is used to "
        ...
        @StarlarkConstructor
        fun createStruct(kwargs: Dict<String?, Any?>?): StructApi?
    }
}
