...
interface ExecGroupCollectionApi : StarlarkValue, StarlarkIndexable {
    /**
     ...
     * [StarlarkRuleContextApi]. This allows a user to pass in a rule ctx to the same places
    ...
    interface ExecGroupContextApi : StarlarkValue {
        @StarlarkMethod(name = "toolchains", structField = true, doc = "Toolchains required for this exec group")
        @Throws(
            EvalException::class
        )
