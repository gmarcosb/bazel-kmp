 ...
 * 
 * 
 * This event is only fired for actions that are remotely fetched and injected, preventing action
 * execution.
 */
class InjectedActionExecutionEvent(action: com.google.devtools.build.lib.actions.Action?) : Postable {
