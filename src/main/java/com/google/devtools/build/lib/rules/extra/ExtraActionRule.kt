 ...
 */
class ExtraActionRule : RuleDefinition {
    ...
    <!-- #END_BLAZE_RULE.NAME -->*/
        return builder /*<!-- #BLAZE_RULE(extra_action).ATTRIBUTE(tools) -->
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE -->*/
            .add(attr("out_templates", STRING_LIST)) /*<!-- #BLAZE_RULE(extra_action).ATTRIBUTE(cmd) -->
        The command to run.
        <p>
        ...
        <!-- #END_BLAZE_RULE.ATTRIBUTE -->*/
            .add(attr("cmd", STRING).mandatory()) /*<!-- #BLAZE_RULE(extra_action).ATTRIBUTE(requires_action_output) -->
    ...
    val metadata: Metadata
        get() = RuleDefinition.Metadata.builder()
            ...
            .factoryClass(ExtraActionFactory::class.java)
            .build()
