...
@StarlarkBuiltin(
    name = "ToolchainInfo", doc = ("Provider returned by <a href=\"\${link toolchains#defining-toolchains}\">toolchain "
            ...
            + "toolchains</a> for more information."), category = DocCategory.PROVIDER
)
interface ToolchainInfoApi : StructApi {
    /** Provider for [ToolchainInfoApi] objects.  */
    ...
    interface Provider : ProviderApi {
        ...
        fun toolchainInfo(kwargs: Dict<String?, Any?>?): ToolchainInfoApi?
    }
}
