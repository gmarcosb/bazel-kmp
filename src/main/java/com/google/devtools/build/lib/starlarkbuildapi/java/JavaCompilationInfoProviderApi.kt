...
interface JavaCompilationInfoProviderApi<FileT : FileApi?> : StarlarkValue {
    @get:StarlarkMethod(
        name = "javac_options",
        structField = true,
        doc = ("A depset of options to java compiler. To get the exact list of options passed to javac"
    ...
    val compilationClasspath: Depset?
    ...
    val bootClasspathList: ImmutableList<FileT?>?
}
