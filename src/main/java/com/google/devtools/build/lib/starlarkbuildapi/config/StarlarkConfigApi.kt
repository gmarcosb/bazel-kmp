 ...
 * 
 * 
 * This exposes methods to describe what kind of build setting (if any) a starlark rule is using
 * the `build_setting` attr of the `rule(...)` function.
 */
@net.starlark.java.annot.StarlarkBuiltin(
    name = "config",
    category = com.google.devtools.build.docgen.annot.DocCategory.TOP_LEVEL_MODULE,
    doc = ("This is a top-level module for creating configuration transitions and build "
...
interface StarlarkConfigApi : net.starlark.java.eval.StarlarkValue {
    ...
    fun intSetting(flag: Boolean?): BuildSettingApi?
    ...
    fun boolSetting(flag: Boolean?): BuildSettingApi?
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            name = "allow_multiple",
            defaultValue = "False",
            doc = ("Deprecated, use a <code>string_list</code> setting with"
    ...
    fun stringSetting(flag: Boolean?, allowMultiple: Boolean?): BuildSettingApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "string_list",
        doc = ("A string list-typed build setting. On the command line pass a list using"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            name = "repeatable",
            defaultValue = "False",
            doc = ("If set, instead of expecting a comma-separated value, this flag is allowed to be"
    ...
    fun stringListSetting(flag: Boolean?, repeatable: Boolean?): BuildSettingApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "string_set",
        doc = ("A string set-typed build setting. The value of this setting will be a <a"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun stringSetSetting(flag: Boolean?, repeatable: Boolean?): BuildSettingApi?

    /** The API for build setting descriptors.  */
    @net.starlark.java.annot.StarlarkBuiltin(
        name = "BuildSetting",
        category = com.google.devtools.build.docgen.annot.DocCategory.BUILTIN,
        doc = ("The descriptor for a single piece of configuration information. If configuration is a "
                + "key-value map of settings like {'cpu': 'ppc', 'copt': '-DFoo'}, this describes a "
                + "single entry in that map.")
    )
    interface BuildSettingApi : net.starlark.java.eval.StarlarkValue

    @net.starlark.java.annot.StarlarkMethod(
        name = "exec", doc = "Creates an execution transition.", parameters = [net.starlark.java.annot.Param(
            name = "exec_group",
            ...
            named = true,
            defaultValue = "None",
            doc = ("The name of the exec group whose execution platform this transition will use. If"
                    + " not provided, this exec transition will use the target's default execution"
                    + " platform.")
        )]
    )
    fun exec(execGroupUnchecked: Any?): ExecTransitionFactoryApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "target", doc = ("Creates a target transition. This is a no-op transition intended for the case where a"
    ...
    fun target(): ConfigurationTransitionApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "none", doc = ("Creates a transition which removes all configuration, unsetting all flags. Intended for"
                + " the case where a dependency is data-only and contains no code that needs to be"
                + " built, but should only be analyzed once.")
    )
    fun none(): ConfigurationTransitionApi?
    ...
    interface ExecTransitionFactoryApi : ConfigurationTransitionApi
    companion object {
        const val FLAG_ARG: String = "flag"
        const val FLAG_ARG_DOC: String = "Whether or not this build setting is callable on the command line."
    }
}
