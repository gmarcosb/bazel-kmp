...
interface StarlarkBuildApiGlobals {
    @net.starlark.java.annot.StarlarkMethod(
        name = "visibility",
        doc = ("<p>Sets the load visibility of the .bzl module currently being initialized."
    ...
    fun visibility(value: Any?, thread: net.starlark.java.eval.StarlarkThread?)

    @net.starlark.java.annot.StarlarkMethod(
        name = "configuration_field",
        doc = ("References a late-bound default value for an attribute of type <a"
