...
interface ActionContext {
    ...
    interface ActionContextRegistry {
         ...
         * 
         * 
         * Note that multiple contexts could have been registered for the same identifying type. In
         * this case the last such registered context will be returned here. Contexts of the same type
         * can also be distinguished using command-line identifiers and some can be [ ][com.google.devtools.build.lib.exec.ExecutorBuilder.addStrategyByContext] from the
