...
interface Subprocess : java.io.Closeable {
    /** Kill the process.  */
    fun destroy(): Boolean
     ...
     * 
     * 
     * Throws `IllegalThreadStateException` if the process has not terminated yet.
     */
    fun exitValue(): Int
     ...
     * 
     * 
     * This may cause the process to be destroyed as a side effect, for example due to a timeout.
     */
