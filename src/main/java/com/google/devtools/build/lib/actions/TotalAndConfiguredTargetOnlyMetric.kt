...
data class TotalAndConfiguredTargetOnlyMetric(val total: Int, val configuredTargetsOnly: Int) {
    companion object {
        fun create(total: Int, configuredTargetsOnly: Int): TotalAndConfiguredTargetOnlyMetric {
            return TotalAndConfiguredTargetOnlyMetric(total, configuredTargetsOnly)
        }
    }
}
