...
@net.starlark.java.annot.StarlarkBuiltin(
    ...
    doc = ("Module providing functions to create actions. Access this module using <a"
            + " href=\"../builtins/ctx.html#actions\"><code>ctx.actions</code></a>.")
)
interface StarlarkActionFactoryApi : net.starlark.java.eval.StarlarkValue {
    @net.starlark.java.annot.StarlarkMethod(
        name = "declare_file", doc = ("Declares that the rule or aspect creates a file with the given filename. If"
                ...
                + " example of use</a>."), parameters = [net.starlark.java.annot.Param(
            name = "filename", doc = ("If no 'sibling' provided, path of the new file, relative "
    ...
    fun declareFile(filename: String?, sibling: Any?): FileApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "declare_directory",
        doc = ("Declares that the rule or aspect creates a directory with the given name, in the "
        ...
        parameters = [net.starlark.java.annot.Param(
            name = "filename", doc = ("If no 'sibling' provided, path of the new directory, relative "
                    + "to the current package. Otherwise a base name for a file "
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun declareDirectory(filename: String?, sibling: Any?): FileApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "declare_symlink",
        doc = ("Declares that the rule or aspect creates a symlink with the given name in the current"
        ...
        parameters = [net.starlark.java.annot.Param(
            name = "filename", doc = ("If no 'sibling' provided, path of the new symlink, relative "
                    + "to the current package. Otherwise a base name for a file "
                    + "('sibling' defines a directory).")
        ), net.starlark.java.annot.Param(
            name = "sibling",
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun declareSymlink(filename: String?, sibling: Any?): FileApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "do_nothing",
        doc = ("Creates an empty action that neither executes a command nor produces any "
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun doNothing(mnemonic: String?, inputs: Any?)

    @net.starlark.java.annot.StarlarkMethod(
        name = "symlink",
        doc = ("Creates an action that writes a symlink in the file system.<p>This function must be"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            positional = false,
            defaultValue = "None",
            doc = "The exact path that the output symlink will point to. No normalization or other "
            ...
            positional = false,
            defaultValue = "None",
            doc = ("May only be used with <code>target_path</code>, not <code>target_file</code>. If"
            ...
            positional = false,
            defaultValue = "False",
            doc = ("May only be used with <code>target_file</code>, not <code>target_path</code>. "
    ...
    @net.starlark.java.annot.StarlarkMethod(
        name = "write",
        doc = ("Creates a file write action. When the action is executed, it will write the given "
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            name = "content",
            allowedTypes = [net.starlark.java.annot.ParamType(type = String::class), net.starlark.java.annot.ParamType(
                type = CommandLineArgsApi::class
            )],
            doc = ("the contents of the file. May be a either a string or an <a"
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            defaultValue = "None",
            positional = false,
            doc = ("File containing list of inputs unused by the action. "
                    + ""
            ...
            named = true,
            positional = false,
            doc = ("Progress message to show to the user during the build, for example, \"Compiling"
            ...
            named = true,
            positional = false,
            doc = ("Whether the action should use the default shell environment, which consists of a"
            ...
            named = true,
            positional = false,
            doc = ("Sets the dictionary of environment variables.<p>If both"
            ...
            named = true,
            positional = false,
            doc = "Runs the action on the given exec group's execution platform. If"
                    + " none, uses the target's default execution platform."
        ), net.starlark.java.annot.Param(
            name = "shadowed_action",
            allowedTypes = [net.starlark.java.annot.ParamType(type = ActionApi::class)],
            defaultValue = "None",
            named = true,
            positional = false,
            doc = ("Runs the action using the given shadowed action's inputs and"
            ...
            named = true,
            positional = false,
            doc = ("A callback function that returns a resource set dictionary, used to estimate"
            ...
            named = true,
            positional = false,
            doc = ("<p>Toolchain type of the executable or tools used in this action.</p><p>If"
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            named = true,
            positional = false,
            doc = ("Command line arguments of the action. Must be a list of strings or "
                    + "<a href=\"#args\"><code>actions.args()</code></a> objects."
                    + ""
            ...
            named = true,
            positional = false,
            doc = ("Shell command to execute. This may either be a string (preferred) or a sequence "
            ...
            named = true,
            positional = false,
            doc = ("Runs the action using the given shadowed action's discovered inputs"
            ...
            named = true,
            positional = false,
            doc = "A callback function for estimating resource usage if run locally. See"
    ...
    @net.starlark.java.annot.StarlarkMethod(
        name = "map_directory",
        doc = ("Creates multiple actions based on the files within one or more input directories, to"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            named = true,
            positional = false,
            doc = ("A dictionary mapping of strings to input directories, as declared by"
            ...
            named = true,
            positional = false,
            doc = ("A dictionary of mapping of strings to additional inputs (only files,"
            ...
            named = true,
            positional = false,
            doc = ("A dictionary mapping of strings to output directories, as declared by"
            ...
            named = true,
            positional = false,
            doc = ("A dictionary mapping of strings to tools (only files, FilesToRunProvider(s) and"
            ...
            named = true,
            positional = false,
            doc = ("A dictionary mapping of strings to additional parameters. The values specify any"
            ...
            named = true,
            positional = false,
            doc = ("Information for scheduling the created actions. See "
                    + "<a href=\"\${link common-definitions#common.tags}\">tags</a> "
                    + "for useful keys.")
        ), net.starlark.java.annot.Param(
            name = "exec_group",
            ...
            named = true,
            positional = false,
            doc = "Run the created actions on the given exec group's execution platform. If"
                    + " none, uses the target's default execution platform."
        ), net.starlark.java.annot.Param(
            name = "toolchain",
            allowedTypes = [net.starlark.java.annot.ParamType(type = Label::class), net.starlark.java.annot.ParamType(
            ...
            named = true,
            positional = false,
            doc = ("<p>Toolchain type of the executable or tools used by the created actions.</p><p>If"
                    + " executable and tools are not coming from a toolchain, set this parameter to"
            ...
            named = true,
            positional = false,
            doc = ("Whether the created actions should use the default shell environment, which"
            ...
            named = true,
            positional = false,
            doc = "A one-word description of the created actions, for example, CppCompile or"
                    + " GoLink."
        ), net.starlark.java.annot.Param(
            name = "implementation",
    ...
    @Throws(net.starlark.java.eval.EvalException::class, java.lang.InterruptedException::class)
    fun mapDirectory(
        inputDirectories: net.starlark.java.eval.Dict<*, *>?,
        additionalInputs: net.starlark.java.eval.Dict<*, *>?,
        outputDirectories: net.starlark.java.eval.Dict<*, *>?,
        tools: net.starlark.java.eval.Dict<*, *>?,
        additionalKwargs: net.starlark.java.eval.Dict<*, *>?,
        executionRequirementsUnchecked: Any?,
        execGroupUnchecked: Any?,
        toolchainUnchecked: Any?,
        useDefaultShellEnv: Boolean?,
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        doc = ("Creates a template expansion action. When the action is executed, it will "
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            named = true,
            positional = false,
            allowedTypes = [net.starlark.java.annot.ParamType(type = TemplateDictApi::class)],
            defaultValue = "unbound",
            doc = "Substitutions to make when expanding the template."
        )]
    )
    ...
    fun expandTemplate(
        template: FileApi?,
        output: FileApi?,
        substitutionsUnchecked: net.starlark.java.eval.Dict<*, *>?,
        executable: Boolean?,
    ...
    fun templateDict(): TemplateDictApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "declare_shareable_artifact",
        parameters = [net.starlark.java.annot.Param(name = "path"), net.starlark.java.annot.Param(
            name = "artifact_root",
            defaultValue = "unbound"
        )],
        documented = false,
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun createShareableArtifact(path: String?, root: Any?, thread: net.starlark.java.eval.StarlarkThread?): FileApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "transform_version_file",
        documented = false,
        doc = ("Similar to <a href=\"#transform_info_file\">transform_info_file</a>, but transforms <a"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            name = "template",
            doc = TEMPLATE_DOC,
            allowedTypes = [net.starlark.java.annot.ParamType(type = FileApi::class)],
            positional = false,
            named = true
        ), net.starlark.java.annot.Param(
            name = "output_file_name",
            doc = VERSION_OUTPUT_DOC,
            allowedTypes = [net.starlark.java.annot.ParamType(type = String::class)],
            positional = false,
            named = true
        )],
        useStarlarkThread = true
    ...
    companion object {
        val TRANSFORM_VERSION_FUNC_DOC: String =
        ...
        val TRANSFORM_INFO_FUNC_DOC: String =
            ("A Starlark callback method which takes <code>dict</code> as an input and  returns"
                    + " <code>dict</code> as an output. The input <code>dict</code> is generated"
                    + " from <a"
                    ...
                    + " pairs. Output <code>dict</code> will serve as a substitutions"
                    + " dictionary for template expansion.")
        val TEMPLATE_DOC: String = ("A <code>template</code> file according to which the output <code>dict</code> from"
                + " <code>transform_func</code> will be formatted and written to a file.")
        val INFO_OUTPUT_DOC: String =
...
""".trimIndent()
        val MAP_DIRECTORY_IMPLEMENTATION_DOC: String = """
