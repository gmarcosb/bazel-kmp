...
@net.starlark.java.annot.StarlarkBuiltin(
    ...
    doc = ("A context object that is passed to the implementation function for a rule or aspect. It"
...
interface StarlarkRuleContextApi<ConstraintValueT : ConstraintValueInfoApi?>
    ...
    fun callParent(thread: net.starlark.java.eval.StarlarkThread?): Any?

    @net.starlark.java.annot.StarlarkMethod(
        name = "created_actions", doc = ("For rules with <a"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun createdActions(): net.starlark.java.eval.StarlarkValue?
    ...
    @get:net.starlark.java.annot.StarlarkMethod(
        name = "workspace_name",
        structField = true,
        doc = ("The name of the workspace, which is effectively the execution root name and runfiles"
    ...
    val fragments: FragmentCollectionApi?

    @get:Throws(net.starlark.java.eval.EvalException::class)
    @get:net.starlark.java.annot.StarlarkMethod(
        name = "configuration", structField = true, doc = ("The current target's build configuration. See the <a"
    ...
    val configuration: BuildConfigurationApi?

    @get:Throws(net.starlark.java.eval.EvalException::class)
    @get:net.starlark.java.annot.StarlarkMethod(
        name = "build_setting_value",
        structField = true,
        doc = ("Value of the build setting represented by the current target. If this isn't the context"
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        parameters = [net.starlark.java.annot.Param(
            name = "target",
            allowedTypes = [net.starlark.java.annot.ParamType(type = TransitiveInfoCollectionApi::class), net.starlark.java.annot.ParamType(
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun instrumentCoverage(targetUnchecked: Any?): Boolean

    @get:Throws(net.starlark.java.eval.EvalException::class)
    @get:net.starlark.java.annot.StarlarkMethod(
        name = "features",
        structField = true,
        doc = ("The set of features that are explicitly enabled by the user for this rule. "
                + "<a href=\"https://github.com/bazelbuild/examples/blob/main/rules/"
                + "features/rule.bzl\">See example of use</a>.")
    )
    val features: com.google.common.collect.ImmutableList<String?>?
    ...
    val disabledFeatures: com.google.common.collect.ImmutableList<String?>?
    ...
    val genfilesDirectory: FileRootApi?

    @net.starlark.java.annot.StarlarkMethod(name = "outputs", structField = true, doc = OUTPUTS_DOC)
    @Throws(net.starlark.java.eval.EvalException::class)
    fun outputs(): net.starlark.java.eval.Structure?

    @net.starlark.java.annot.StarlarkMethod(
        name = "rule",
        structField = true,
        doc = ("Rule attributes descriptor for the rule that the aspect is applied to."
                + " Only available in aspect implementation functions.")
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun rule(): StarlarkAttributesCollectionApi?

    @net.starlark.java.annot.StarlarkMethod(
        name = "aspect_ids", structField = true, doc = ("A list of ids for all aspects applied to the target."
                + " Only available in aspect implementation functions.")
    )
    @Throws(net.starlark.java.eval.EvalException::class)
    fun aspectIds(): com.google.common.collect.ImmutableList<String?>?
    ...
    fun targetPlatformHasConstraint(constraintValue: ConstraintValueT?): Boolean

    @net.starlark.java.annot.StarlarkMethod(
        name = "exec_groups", structField = true, doc = ("A collection of the execution groups available for this rule,"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun tokenize(optionString: String?): net.starlark.java.eval.Sequence<String?>?
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun checkPlaceholders(template: String?, allowedPlaceholders: net.starlark.java.eval.Sequence<*>?): Boolean

    @net.starlark.java.annot.StarlarkMethod(
        name = "expand_make_variables",
        doc = ("<b>Deprecated.</b> Use <a href=\"../builtins/ctx.html#var\">ctx.var</a> to access the"
    ...
    @Throws(net.starlark.java.eval.EvalException::class, java.lang.InterruptedException::class)
    fun expandMakeVariables(
        attributeName: String?,
        command: String?,
        additionalSubstitutions: net.starlark.java.eval.Dict<*, *>?
    ): String?

    @get:Throws(java.lang.InterruptedException::class, net.starlark.java.eval.EvalException::class)
    @get:net.starlark.java.annot.StarlarkMethod(
        name = "info_file",
        structField = true,
        documented = true,
        doc = ("The file that is used to hold the non-volatile workspace status for the "
                + "current build request. See documentation for --workspace_status_command "
                + "for more information.")
    )
    val stableWorkspaceStatus: FileApi?
    ...
    @get:net.starlark.java.annot.StarlarkMethod(
        ...
        structField = true,
        documented = true,
        doc = ("The file that is used to hold the volatile workspace status for the "
                + "current build request. See documentation for --workspace_status_command "
                + "for more information.")
    )
    val volatileWorkspaceStatus: FileApi?
    ...
    @get:net.starlark.java.annot.StarlarkMethod(
        ...
        structField = true,
        documented = true,
        doc = ("Deprecated: Use <code>ctx.label.package + '/BUILD'</code>. "
                + "The path to the BUILD file for this rule, relative to the source root.")
    )
    val buildFileRelativePath: String?

    @net.starlark.java.annot.StarlarkMethod(
        name = "expand_location",
        doc = ("Expands all <code>$(location ...)</code> templates in the given string by replacing "
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            defaultValue = "[]",
            named = true,
            doc = ("List of targets for additional lookup information. These are expanded as follows:"
    ...
    fun expandLocation(
        input: String?,
        targets: net.starlark.java.eval.Sequence<*>?,
        shortPaths: Boolean,
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            defaultValue = "False",
            named = true,
            doc = ("<b>Use of this parameter is not recommended. See <a"
            ...
            allowedTypes = [net.starlark.java.annot.ParamType(type = net.starlark.java.eval.Dict::class), net.starlark.java.annot.ParamType(
                type = Depset::class,
                generic1 = SymlinkEntryApi::class
            )],
            doc = ("Either a SymlinkEntry depset or the map of symlinks to be added to the runfiles."
            ...
            doc = ("Either a SymlinkEntry depset or a map of symlinks to be added to the runfiles. See"
    ...
    @net.starlark.java.annot.StarlarkMethod(
        ...
        doc = ("<i>(Experimental)</i> Returns a tuple <code>(inputs, command, empty list)</code>"
        ...
        parameters = [net.starlark.java.annot.Param(
            ...
            named = true,
            positional = false,
            doc = "Shall we expand $(location) variables? See <a"
            ...
            named = true,
            positional = false,
            doc = ("Information for scheduling the action to resolve this command. See "
    ...
    fun resolveCommand(
        ...
        labelDictUnchecked: net.starlark.java.eval.Dict<*, *>?,
        executionRequirementsUnchecked: net.starlark.java.eval.Dict<*, *>?,
        thread: net.starlark.java.eval.StarlarkThread?
    ): net.starlark.java.eval.Tuple?

    @net.starlark.java.annot.StarlarkMethod(
        name = "resolve_tools",
        doc = ("Returns a tuple <code>(inputs, empty list)</code> of the depset of resolved inputs"
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun resolveTools(tools: net.starlark.java.eval.Sequence<*>?): net.starlark.java.eval.Tuple?

    @net.starlark.java.annot.StarlarkMethod(
        name = "package_relative_label", doc = """
          Converts the input string into a <a href='../builtins/Label.html'>Label</a> object, in the context of the package of the target currently being analyzed. If the input is already a <code>Label</code>, it is returned unchanged.<p>The result of this function is the same <code>Label</code> value as would be produced by passing the given string to a label-valued attribute of the rule and accessing the corresponding <a href='../builtins/Target.html#label'><code>label</code></a> field.
          <p><i>Usage note:</i> The difference between this function and <a href='../builtins/Label.html#Label'>Label()</a></code> is that <code>Label()</code> uses the context of the package of the <code>.bzl</code> file that called it, not the package of the target currently being analyzed. This function has the same behavior as <a href='../toplevel/native.html#package_relative_label'>
    ...
    @Throws(net.starlark.java.eval.EvalException::class)
    fun packageRelativeLabel(input: Any?): Label?

    companion object {
        val EXECUTABLE_DOC: String = ("A <code>struct</code> containing executable files defined in <a"
                ...
                + " example of use</a>.")
        val FILES_DOC: String = ("A <code>struct</code> containing files defined in <a"
                ...
                + " example of use</a>.")
        val FILE_DOC: String = ("A <code>struct</code> containing files defined in <a"
                + " href='../toplevel/attr.html#label'>label type attributes</a> marked as <a"
                ...
                + " example of use</a>.")
        val ATTR_DOC: String = ("A struct to access the values of the <a"
        ...
        val SPLIT_ATTR_DOC: String =
            ("A struct to access the values of attributes with split configurations. If the attribute is "
                    ...
                    + "merged together.")
        val OUTPUTS_DOC: String = ("A pseudo-struct containing all the predeclared output files, represented by <a"
