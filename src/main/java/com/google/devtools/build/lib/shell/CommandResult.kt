 ...
 * stderr.
 * 
 * @param stdoutStream Returns the stdout [ByteArrayOutputStream].
 * @param stderrStream Returns the stderr [ByteArrayOutputStream].
 ...
 */
class CommandResult(
    stdoutStream: java.io.ByteArrayOutputStream?,
    stderrStream: java.io.ByteArrayOutputStream?,
    terminationStatus: TerminationStatus?,
    wallExecutionTime: java.util.Optional<java.time.Duration?>?,
    userExecutionTime: java.util.Optional<java.time.Duration?>?,
    systemExecutionTime: java.util.Optional<java.time.Duration?>?
) {
    val stdout: ByteArray?
         ...
         */
        get() = this.stdoutStream.toByteArray()
    ...
    val stderr: ByteArray?
         ...
         * @throws IllegalStateException if output was not collected
         */
        get() = this.stderrStream.toByteArray()

    fun logThis() {
        logger.atFiner().log("%s", LazyArgs.lazy<TerminationStatus?>(LazyArg { this.terminationStatus }))

        if (this.stdoutStream === NO_OUTPUT_COLLECTED) {
            return
        }
        logger.atFiner().log("Stdout: %s", LazyArgs.lazy<String?>(LazyArg {
            LogUtil.toTruncatedString(
                this.stdout
            )
        }))
        logger.atFiner().log("Stderr: %s", LazyArgs.lazy<String?>(LazyArg {
            LogUtil.toTruncatedString(
                this.stderr
            )
        }))
    ...
    abstract class Builder {
        ...
        abstract fun setStdoutStream(stdout: java.io.ByteArrayOutputStream?): Builder?

        /** Sets the stderr output for the command.  */
        abstract fun setStderrStream(stderr: java.io.ByteArrayOutputStream?): Builder?

        /** Sets the termination status for the command.  */
        abstract fun setTerminationStatus(terminationStatus: TerminationStatus?): Builder?

        /** Sets the wall execution time.  */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setWallExecutionTime(wallExecutionTime: java.time.Duration): Builder {
            setWallExecutionTime(java.util.Optional.of<java.time.Duration?>(wallExecutionTime))
            return this
        }

        /** Sets or clears the wall execution time.  */
        abstract fun setWallExecutionTime(wallExecutionTime: java.util.Optional<java.time.Duration?>?): Builder?

        /** Sets the user execution time.  */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setUserExecutionTime(userExecutionTime: java.time.Duration): Builder {
            setUserExecutionTime(java.util.Optional.of<java.time.Duration?>(userExecutionTime))
            return this
        }

        /** Sets or clears the user execution time.  */
        abstract fun setUserExecutionTime(userExecutionTime: java.util.Optional<java.time.Duration?>?): Builder?

        /** Sets the system execution time.  */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setSystemExecutionTime(systemExecutionTime: java.time.Duration): Builder {
            setSystemExecutionTime(java.util.Optional.of<java.time.Duration?>(systemExecutionTime))
            return this
        }

        /** Sets or clears the system execution time.  */
        abstract fun setSystemExecutionTime(systemExecutionTime: java.util.Optional<java.time.Duration?>?): Builder?

        /** Builds a [CommandResult] object.  */
        abstract fun build(): CommandResult?
    }
    ...
    val wallExecutionTime: java.util.Optional<java.time.Duration?>?
    val userExecutionTime: java.util.Optional<java.time.Duration?>?
    val systemExecutionTime: java.util.Optional<java.time.Duration?>?
    ...
    init {
        ...
        java.util.Objects.requireNonNull<java.io.ByteArrayOutputStream?>(stdoutStream, "stdoutStream")
        java.util.Objects.requireNonNull<java.io.ByteArrayOutputStream?>(stderrStream, "stderrStream")
        java.util.Objects.requireNonNull<TerminationStatus?>(terminationStatus, "terminationStatus")
        java.util.Objects.requireNonNull<java.util.Optional<java.time.Duration?>?>(
            wallExecutionTime,
            "wallExecutionTime"
        )
        java.util.Objects.requireNonNull<java.util.Optional<java.time.Duration?>?>(
    ...
    companion object {
        ...
        @kotlin.jvm.JvmField
        val EMPTY_OUTPUT: java.io.ByteArrayOutputStream = object : java.io.ByteArrayOutputStream() {
        ...
        val NO_OUTPUT_COLLECTED: java.io.ByteArrayOutputStream = object : java.io.ByteArrayOutputStream() {
            @kotlin.jvm.Synchronized
            override fun toByteArray(): ByteArray? {
                throw java.lang.IllegalStateException("Output was not collected")
            }
        }

        /** Returns a new [CommandResult.Builder].  */
        @kotlin.jvm.JvmStatic
        fun builder(): Builder {
            return AutoBuilder_CommandResult_Builder()
        }
    }
}
