 ...
 */
interface AnsiTerminalWriter {
    /**
     * Write some text to the user
     */
    @Throws(IOException::class)
    fun append(text: String?): AnsiTerminalWriter?

    /**
     * Start a new line in the way appropriate for the given terminal
     */
    @Throws(IOException::class)
    fun newline(): AnsiTerminalWriter?
     ...
     */
    @Throws(IOException::class)
    fun okStatus(): AnsiTerminalWriter?
     ...
     */
    @Throws(IOException::class)
    fun failStatus(): AnsiTerminalWriter?
