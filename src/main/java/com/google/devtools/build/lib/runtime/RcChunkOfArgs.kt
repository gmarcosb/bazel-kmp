 ...
 * 
 * 
 * Each chunk comes from a single rc file, but the args stored here may not contain the entire
 * file if its contents were interrupted by an import statement.
 */
internal class RcChunkOfArgs(
    ...
    override fun equals(o: Any?): Boolean {
        if (o is RcChunkOfArgs) {
            return this.rcFile == o.rcFile && this.args == o.args
        }
        return false
    }

    override fun hashCode(): Int {
        return this.rcFile!!.hashCode() + this.args!!.hashCode()
    }
}
