 ...
 */
object ContextAndFlagGuardedValue {
    /**
     ...
     */
    fun onlyInAllowedReposOrWhenIncompatibleFlagIsFalse(
        flag: String, obj: Any, allowedEntries: ImmutableSet<PackageIdentifier?>
    ): GuardedValue {
        val flagGuard = FlagGuardedValue.onlyWhenIncompatibleFlagIsFalse(flag, obj)
        val contextGuard = ContextGuardedValue.onlyInAllowedRepos(obj, allowedEntries)
