...
class CgroupsInfoV1(type: com.google.devtools.build.lib.sandbox.CgroupsInfo.Type?, cgroupDir: java.io.File?) :
    CgroupsInfo(type, com.google.devtools.build.lib.sandbox.CgroupsInfo.Version.V1, cgroupDir) {
    override fun createBlazeSpawnsCgroup(procSelfCgroupPath: String): CgroupsInfo {
        ...
        val blazeSpawnsDir: java.io.File =
            java.io.File(blazeProcessCgroupDir, "blaze_" + java.lang.ProcessHandle.current().pid() + "_spawns")
        blazeSpawnsDir.mkdirs()
        blazeSpawnsDir.deleteOnExit()
        return CgroupsInfoV1(com.google.devtools.build.lib.sandbox.CgroupsInfo.Type.BLAZE_SPAWNS, blazeSpawnsDir)
    }
    ...
    override fun createIndividualSpawnCgroup(dirName: String, memoryLimitMb: Int): CgroupsInfo {
        ...
        val spawnCgroupDir: java.io.File = java.io.File(cgroupDir, dirName)
        spawnCgroupDir.mkdirs()
        spawnCgroupDir.deleteOnExit()
        try {
            if (memoryLimitMb > 0) {
                com.google.common.io.Files.asCharSink(
                    java.io.File(spawnCgroupDir, "memory.limit_in_bytes"),
        ...
        return CgroupsInfoV1(com.google.devtools.build.lib.sandbox.CgroupsInfo.Type.SPAWN, spawnCgroupDir)
    }

    val memoryUsageInKb: Int
        get() = getMemoryUsageInKbFromFile("memory.usage_in_bytes")
    ...
    companion object {
         ...
         * 
         * 
         * The `/proc/self/cgroup` file look like this in v1:
         * 
         * <pre>
         * 8:net:/some/path
        ...
        private fun getBlazeProcessCgroupDir(mountPoint: java.io.File?, procSelfCgroupPath: String): java.io.File {
            val controllers: MutableList<String> = com.google.common.io.Files.readLines(
                java.io.File(procSelfCgroupPath),
                java.nio.charset.StandardCharsets.UTF_8
            )
            val memoryController: String =
                controllers.stream()
                    .filter { controller: String -> controller.contains("memory") }
                    .findFirst()
                    .orElseThrow<java.lang.IllegalStateException?>(
            ...
            val parts: MutableList<String?> =
                com.google.common.base.Splitter.on(":").limit(3).splitToList(memoryController)
