...
interface OptionsSupplier {
    /**
     * Returns the startup options this module contributes.
     * 
     * 
     * This method will be called extremely early during server startup.
     */
     ...
     * 
     * 
     * This method may be called at any time, and the returned value may be cached. Implementations
     ...
     * 
     * 
     * This method is also used to generate command-line documentation; in order to avoid
     ...
     * 
     * 
     * If you want to add options to all commands, override [.getCommonCommandOptions]
     * instead.
     * 
     * @param commandName the command name, e.g. "build" or "test".
     */
    fun getCommandOptions(commandName: String?): Iterable<java.lang.Class<out com.google.devtools.common.options.OptionsBase?>?>?
