...
/**
 * Represents the termination status of a command.  [Process.waitFor] is
 ...
 */
class TerminationStatus @kotlin.jvm.JvmOverloads constructor(
    /**
     * Returns the exit code returned by the subprocess.
     */
    val rawExitCode: Int,
    private val timedOut: Boolean,
    wallExecutionTime: java.util.Optional<java.time.Duration?>? = java.util.Optional.empty<java.time.Duration?>(),
    userExecutionTime: java.util.Optional<java.time.Duration?>? = java.util.Optional.empty<java.time.Duration?>(),
    systemExecutionTime: java.util.Optional<java.time.Duration?>? = java.util.Optional.empty<java.time.Duration?>()
) {
    private val wallExecutionTime: java.util.Optional<java.time.Duration?>?
    private val userExecutionTime: java.util.Optional<java.time.Duration?>?
    private val systemExecutionTime: java.util.Optional<java.time.Duration?>?

    /**
     * Returns true iff the process exited with code 0.
     */
    fun success(): Boolean {
        return exited() && this.exitCode == 0
    }
     ...
     * 
     * 
     * TerminationStatus objects are considered equal if they have the same waitResult.
     * 
     * @param rawExitCode the value returned by [java.lang.Process.waitFor].
    ...
    fun exited(): Boolean {
        return !timedOut && (this.rawExitCode < SIGNAL_1 || this.rawExitCode > SIGNAL_63)
    }
    ...
    val exitCode: Int
         ...
         */
        get() {
            check(exited()) { "getExitCode() not defined" }
            return this.rawExitCode
        }

    val terminatingSignal: Int
        /**
         * Returns the number of the signal that terminated the process.  Undefined
         * if exited() returns true.
         */
        get() {
            check(!(exited() || timedOut)) { "getTerminatingSignal() not defined" }
            return this.rawExitCode - SIGNAL_1 + 1
        }
     ...
     */
    fun getWallExecutionTime(): java.util.Optional<java.time.Duration?>? {
     ...
     * implemented for the current platform
     */
    fun getUserExecutionTime(): java.util.Optional<java.time.Duration?>? {
     ...
     * implemented for the current platform
     */
    fun getSystemExecutionTime(): java.util.Optional<java.time.Duration?>? {
    ...
    fun toShortString(): String? {
        return if (exited())
            ...
            (if (timedOut) "Timeout" else getSignalString(this.terminatingSignal))
    }

    override fun toString(): String {
        if (exited()) {
            return "Process exited with status " + this.exitCode
        } else if (timedOut) {
            return "Timed out"
        } else {
            return "Process terminated by signal " + this.terminatingSignal
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
        return other is TerminationStatus
                && other.rawExitCode == this.rawExitCode
    }

    /** Builder for [TerminationStatus] objects.  */
    class Builder {
        ...
        // object.
        private var waitResponse: Int? = null
        private var timedOut: Boolean? = null

        private var wallExecutionTime: java.util.Optional<java.time.Duration?> =
            java.util.Optional.empty<java.time.Duration?>()
        private var userExecutionTime: java.util.Optional<java.time.Duration?> =
            java.util.Optional.empty<java.time.Duration?>()
        private var systemExecutionTime: java.util.Optional<java.time.Duration?> =
            java.util.Optional.empty<java.time.Duration?>()

        /** Sets the value returned by [java.lang.Process.waitFor].  */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setWaitResponse(waitResponse: Int): Builder {
        ...
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setTimedOut(timedOut: Boolean): Builder {
        ...
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setWallExecutionTime(wallExecutionTime: java.time.Duration): Builder {
            this.wallExecutionTime = java.util.Optional.of<java.time.Duration?>(wallExecutionTime)
            return this
        }

        /** Sets the user execution time.  */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setUserExecutionTime(userExecutionTime: java.time.Duration): Builder {
            this.userExecutionTime = java.util.Optional.of<java.time.Duration?>(userExecutionTime)
            return this
        }

        /** Sets the system execution time.  */
        @com.google.errorprone.annotations.CanIgnoreReturnValue
        fun setSystemExecutionTime(systemExecutionTime: java.time.Duration): Builder {
            this.systemExecutionTime = java.util.Optional.of<java.time.Duration?>(systemExecutionTime)
            return this
        }

        /** Builds a [TerminationStatus] object.  */
        fun build(): TerminationStatus {
            checkNotNull(waitResponse) { "waitResponse never set" }
            checkNotNull(timedOut) { "timedOut never set" }
    ...
    companion object {
         ...
         */
        private val SIGNAL_STRINGS = arrayOf<String>(
            null,
            "Hangup",
            "Interrupt",
            "Quit",
        ...
        private fun getSignalString(signum: Int): String {
            return if (signum > 0 && signum < SIGNAL_STRINGS.size)
        ...
        val SIGNAL_1: Int = 128 + 1

        @kotlin.jvm.JvmField
        @com.google.common.annotations.VisibleForTesting
        val SIGNAL_63: Int = 128 + 63

        @kotlin.jvm.JvmField
        @com.google.common.annotations.VisibleForTesting
        val SIGNAL_SIGABRT: Int = 128 + 6

        @kotlin.jvm.JvmField
        @com.google.common.annotations.VisibleForTesting
        val SIGNAL_SIGKILL: Int = 128 + 9

        @kotlin.jvm.JvmField
        @com.google.common.annotations.VisibleForTesting
        val SIGNAL_SIGBUS: Int = 128 + 10

        @kotlin.jvm.JvmField
        @com.google.common.annotations.VisibleForTesting
        val SIGNAL_SIGTERM: Int = 128 + 15

        /**
         * Returns true if the given exit code represents a crash.
         * 
         * 
         * This is a static function that processes a raw exit status because that's all the
         * information that we have around in the single use case of this function. Propagating a [ ] object to that point would be costly. If this function is needed for
         * anything else, then this should be reevaluated.
         */
        @kotlin.jvm.JvmStatic
        fun crashed(rawStatus: Int): Boolean {
            return rawStatus == SIGNAL_SIGABRT || rawStatus == SIGNAL_SIGBUS
        }

        /** Returns a new [TerminationStatus.Builder].  */
        @kotlin.jvm.JvmStatic
        fun builder(): Builder {
            return com.google.devtools.build.lib.shell.TerminationStatus.Builder()
        }
    }
}
