...
interface TargetEdgeObserver {
    ...
    fun edge(
        ...
        to: com.google.devtools.build.lib.packages.Target?
    )
     ...
     */
    fun missingEdge(target: com.google.devtools.build.lib.packages.Target?, to: Label?, e: NoSuchThingException?)
     ...
     */
    fun node(node: com.google.devtools.build.lib.packages.Target?)
}
