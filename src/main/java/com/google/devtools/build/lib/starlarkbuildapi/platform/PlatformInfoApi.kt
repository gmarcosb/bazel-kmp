...
@StarlarkBuiltin(
    name = "PlatformInfo", doc = ("Provides access to data about a specific platform. See "
...
interface PlatformInfoApi<ConstraintSettingInfoT : ConstraintSettingInfoApi?, ConstraintValueInfoT : ConstraintValueInfoApi?>
    : StructApi {
    @StarlarkMethod(
        name = "label",
    ...
    @StarlarkMethod(
        name = "constraints",
        doc = ("The <a href=\"ConstraintValueInfo\">ConstraintValueInfo</a> instances that define "
                + "this platform."),
        structField = true,
        enableOnlyWithFlag = BuildLanguageOptions.EXPERIMENTAL_PLATFORMS_API
    )
    fun constraints(): ConstraintCollectionApi<ConstraintSettingInfoT?, ConstraintValueInfoT?>?

    companion object {
        val EXPERIMENTAL_WARNING: String =
