 ...
 * 
 * 
 * The names used here are adapted from those used in Joshua Bloch's book "Effective Java", which
 * are also described at <http:></http:>//www.ibm.com/developerworks/java/library/j-jtp09263/>.
 * 
 * 
 * These attributes are just documentation. They don't have any run-time effect. The main aim is
...
class ThreadSafety {
    ...
    annotation class ThreadCompatible
    ...
    annotation class ThreadHostile
    ...
    annotation class ConditionallyThreadSafe
    ...
    annotation class ConditionallyThreadCompatible
}
