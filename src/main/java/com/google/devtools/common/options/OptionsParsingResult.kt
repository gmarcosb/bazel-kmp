 ...
 */
interface OptionsParsingResult : com.google.devtools.common.options.OptionsProvider {
    /**
     ...
     */
    fun getPreDoubleDashResidue(): MutableList<String?>?

    /**
     * Returns if the named option was specified explicitly in a call to parse.
     */
    fun containsExplicitOption(string: String?): Boolean
     ...
     * 
     * 
     * The returned list includes undocumented, hidden or implicit options, and should be filtered
     ...
     */
    // TODO(b/150222792): make this aware of Starlark options.
    fun asListOfCanonicalOptions(): MutableList<com.google.devtools.common.options.ParsedOptionDescription?>?
     ...
     */
    // TODO(b/150222792): make this aware of Starlark options
    fun asListOfOptionValues(): MutableList<com.google.devtools.common.options.OptionValueDescription?>?

    /** Returns all non-default option values, including implicit options.  */ // TODO(b/150222792): make this aware of Starlark options
     ...
     * 
     * 
     * The contract is that if the returned set of options is passed to an options parser with the
