 ...
 * 
 * 
 *  * Since these are for grouping, we want useful sizes of groups. Somewhere between 5 and 200
 ...
 *  * Each option needs to belong to exactly one of these groups, so the categories should be
 * clearly distinct.
 *  * These are easy to change, and not brittle, so feel free to add new ones. However, if you
...
enum class OptionDocumentationCategory {
    /**
