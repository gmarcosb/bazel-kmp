...
enum class OptionMetadataTag(@kotlin.jvm.JvmField private val value: Int) {
     ...
     * 
     * 
     * Note: this is separate from UNDOCUMENTED flags, which are flags we don't want listed and
     ...
     * 
     * 
     * These should be in category [OptionDocumentationCategory.UNDOCUMENTED].
     */
    HIDDEN(3),
     ...
     * These should be in category [OptionDocumentationCategory.UNDOCUMENTED].
     */
    INTERNAL(4),  // reserved TRIGGERED_BY_ALL_INCOMPATIBLE_CHANGES(5)
