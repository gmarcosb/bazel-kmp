 ...
 * 
 * 
 * For example, this could control whether symbol "Foo" exists in the Starlark global frame: such
 ...
 * guard will throw a descriptive [EvalException] when "Foo" would be accessed without the
 * proper flag.
 */
interface GuardedValue {
     ...
     */
    fun getErrorFromAttemptingAccess(name: String?): String?
     ...
     * client data.
     */
    fun isObjectAccessibleUsingSemantics(
