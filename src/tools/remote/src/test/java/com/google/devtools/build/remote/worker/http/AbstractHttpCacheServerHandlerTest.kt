...
class AbstractHttpCacheServerHandlerTest {
    @Test
    fun testValidUri() {
        Truth.assertThat(
            AbstractHttpCacheServerHandler.Companion.isUriValid(
    ...
    fun testInvalidUri() {
        ...
        Truth.assertThat(
            ...
            .isFalse()
        Truth.assertThat(
            AbstractHttpCacheServerHandler.Companion.isUriValid("http://localhost:8080/cas/823rhf&*%OL%_^")
        )
            .isFalse()
        Truth.assertThat(AbstractHttpCacheServerHandler.Companion.isUriValid("http://localhost:8080/ac/823rhf&*%OL%_^"))
            .isFalse()
    }
}
